 ...
 * VERSIÓN REFACTORIZADA - Componentes modulares y organizados
 * 
 * @format
 */
...
const ClockIcon = ({ color = '#FFFFFF', size = 24 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path 
      d="M12 7v5l1.5 2.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0" 
      stroke={color} 
      strokeWidth="2" 
      strokeLinecap="round" 
      strokeLinejoin="round"
...
const DollarIcon = ({ color = '#FFFFFF', size = 24 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path 
      d="M12 7v10" 
      stroke={color} 
    ...
    />
    <Path 
      d="M15 9.947C14.5 9.3 13.8 8.5 12 8.5S9 9.514 9 9.947s.068.98 1 1.553c.752.462 2.668.544 3.5 1 1.179.647 1.35 1.32 1.35 1.552 0 .632-1.432 1.433-2.85 1.448-1.464.015-2.5-.8-3-1.448" 
      stroke={color} 
      strokeWidth="2" 
      strokeLinecap="round" 
      strokeLinejoin="round"
...
const BoxIcon = ({ color = '#FFFFFF', size = 24 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path 
...
const CalendarScreen = (): React.JSX.Element => {
  ...
  // Función para manejar la pantalla de crear cita
  const handleCreateAppointmentPress = () => {
    console.log('📅 Abriendo pantalla de crear cita');
    setShowCreateAppointmentScreen(true);
  };

  const handleCreateAppointmentBack = () => {
    console.log('🔙 Cerrando pantalla de crear cita');
    setShowCreateAppointmentScreen(false);
  };

  // Función para manejar la pantalla de crear venta
  const handleCreateSalePress = () => {
    console.log('💰 Abriendo pantalla de crear venta');
    setShowCreateSaleScreen(true);
  };

  const handleCreateSaleBack = () => {
    console.log('🔙 Cerrando pantalla de crear venta');
    setShowCreateSaleScreen(false);
  };

  // Función para manejar la pantalla de productos
  const handleProductsPress = () => {
    console.log('📦 Abriendo pantalla de productos');
    setShowProductsScreen(true);
  };

  const handleProductsBack = () => {
    console.log('🔙 Cerrando pantalla de productos');
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Pantalla de Crear Cita */}
      <Modal
        animationType="slide"
        transparent={false}
        visible={showCreateAppointmentScreen}
        onRequestClose={handleCreateAppointmentBack}
      >
        <CreateAppointmentScreen
          onGoBack={handleCreateAppointmentBack}
        />
      </Modal>

      {/* Pantalla de Crear Venta */}
      <Modal
        animationType="slide"
        transparent={false}
        visible={showCreateSaleScreen}
        onRequestClose={handleCreateSaleBack}
      >
        <CreateSaleScreen
          onGoBack={handleCreateSaleBack}
        />
      </Modal>
      ...
      <Modal
        animationType="slide"
        transparent={false}
        visible={showProductsScreen}
        onRequestClose={handleProductsBack}
      >
        <ProductsScreen
          onGoBack={handleProductsBack}
        />
      </Modal>
